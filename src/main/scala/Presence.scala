...
*/
    val interestRegion = "file:///asap_date/aree_roma.csv"
    ...
    val userCallsPerDate  = sc.textFile("hdfs://sith0:9000/user/spapagian/dataset_simulated/REPORT_ESTRAZ_TRAFF_COMUNE_ROMA_20160301.csv")
